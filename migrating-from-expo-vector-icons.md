...
Since SDK 54, we recommend using [react-native-vector-icons](https://github.com/oblador/react-native-vector-icons) instead of `@expo/vector-icons`. This short guide will help you migrate your existing code. Please [open an issue](https://github.com/expo/vector-icons) if you encounter a problem.
...
> [!WARNING]
> Mixing imports of the same icon families from `@expo/vector-icons` and `@react-native-vector-icons/*` in a project leads to hard-to-diagnose issues, ensure you replace all imports.
