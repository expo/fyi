...
- If you are still using Intel workers for your iOS builds, then [migrate to the much faster M1 workers](https://expo.fyi/intel-to-m1). [Learn more](https://blog.expo.dev/m1-workers-on-eas-build-dcaa2c1333ad)
